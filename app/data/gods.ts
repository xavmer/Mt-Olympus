...
export const gods: God[] = [
    ...
    },
    {
        ...
        role: "god",
        symbol: "🔥",
        domain: "Blacksmiths, Craftsmen, Fire, Crafts in General",
        description: "The amputee god of the forge. He builds magnificent palaces, great inventions and all sorts of wonders for the gods on Olympus.",
        primarySource: "Homer, Odyssey 8.266-369",
